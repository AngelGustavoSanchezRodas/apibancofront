...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Sidebar */}
      <aside className="w-64 bg-blue-950/95 backdrop-blur-md border-r border-blue-900/50 text-white flex flex-col">
        <div className="p-6 border-b border-slate-800">
          <h1 className="text-2xl font-bold font-serif text-gold-500">Banco Admin</h1>
        </div>
      ...
      <main className="flex-1 flex flex-col">
        <header className="h-16 bg-white/80 backdrop-blur-sm border-b border-gray-200 flex items-center justify-between px-8 z-10">
